...
export class StandardResponse {
  ...
  @Type(() => MedicGetAllDto) //esto devuelve metadata, por eso se instala la libreria para habilitar el uso de metadata
  results: MedicGetAllDto[]
...
export class MedicGetAllResponse {
  ...
  const result = instanceToPlain(listMedic);
    ...
    return plainToInstance(StandardResponse, {results: result}, {groups: ["admin"]});
  }
}